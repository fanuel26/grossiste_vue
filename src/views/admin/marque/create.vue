  ...
  <div>
    ...
    <section class="container py-4" data-aos="fade-up" data-aos-delay="100">
      ...
      <div class="mt-4 row">
        <div class="col-md-3">
          <div class="p-4 card">
            <h5 class="text-center">Creer une marque</h5>
            <form class="mt-4" method="post" @submit.prevent="marque_create">
        ...
        <div class="my-4 col-md-9">
          <div class="table-responsive">
            <table class="table table-striped table-hover display">
              ...
              <tbody>
                <tr v-for="cat in marques" :key="cat.id">
...
export default {
  ...
  methods: {
    ...
    marque_create() {
      if (this.nom != null) {
        this.$http.post(`${this.callback}/marque`, { nom: this.nom }).then(
          (response) => {
            let data = response.body;
